...
const keyToSound = new Map([
  ...
  ['KeyY', 6], ['KeyU', 7], ['KeyI', 8], ['KeyO', 9], ['KeyP', 10],
  ['KeyA', 11], ['KeyS', 12], ['KeyD', 13], ['KeyF', 14], ['KeyG', 15],
  ['KeyH', 16], ['KeyJ', 17], ['KeyK', 18], ['KeyL', 19], ['Semicolon', 20],
  ['KeyZ', 21], ['KeyX', 22], ['KeyC', 23], ['KeyV', 24], ['KeyB', 25],
  ['KeyN', 26], ['KeyM', 27], ['Comma', 28], ['Period', 29], ['Slash', 30]
]);
...
const Soundboard = ({ loaded, kits, playSound }: Props) => {
  ...
  return (
    <div className="lg:flex hidden items-center min-h-[300px] bg-neo-lime border-6 border-black overflow-auto shadow-brutal mb-4 p-4">
      <div className="w-[5%] flex justify-center">
        <div className="bg-black p-2 rounded">
          <svg className="fill-neo-yellow w-[28px]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
      ...
      {loaded ? (
        ...
        <div className="flex justify-center py-4 m-auto w-full">
          <svg className="animate-spin w-[30px] fill-black" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
      ...
      <div className="w-[5%] flex justify-center">
        <div className="bg-black p-2 rounded">
          <svg className="fill-neo-yellow w-[18px]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
